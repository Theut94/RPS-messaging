...
public class Game
{
    ...
    public GameFinishedEvent? ReceivePlayerEvent(PlayerMovedEvent e)
    {
        ...
        using var activity = Helpers.Monitoring.ActivitySource.StartActivity("Receiving player event", System.Diagnostics.ActivityKind.Consumer, parentContext.ActivityContext);
